	...
	private void initialize() 
	{
		...
		btnBoutonAfficherLeMessage.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				/*
				* On passe dans cette méthode lorsque l'on clique sur le bouton
				* C'est ici que l'on peut placer le code à executer lors du clique sur ce bouton
				*/
		...
		/*------------------------------------------------------------------------------*/
		/*création du label où sera affiché le message"*/
